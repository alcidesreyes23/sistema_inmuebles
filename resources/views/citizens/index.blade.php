    ...
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        <li class="nav-item" role="presentation">
            <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button"
                role="tab" aria-controls="home" aria-selected="true">Registro Ciudadano</button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button"
                role="tab" aria-controls="profile" aria-selected="false">Nuevo Ciudadano</button>
        </li>
    </ul>
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-12 col-sm-12 col-md-6 my-2">
                            ...
                            <input class="form-control" type="date" id="txtId" name="fecha_nacimiento"
                                placeholder="NACIMIENTO" data-validetta="required">
                        </div>
                        <div class="col-12 col-sm-12 col-md-6 my-2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-12 col-md-6 my-2">
                                ...
                                <input class="form-control" type="text" id="apellidos" name="apellidos"
                                    placeholder="Apellidos" data-validetta="required">
                            </div>
                            <div class="col-12 col-sm-12 col-md-6 my-2">
                                <p class="text-muted text-gray">Género</p>
