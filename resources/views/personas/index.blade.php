...
<ul class="nav nav-tabs" id="myTab" role="tablist">
    <li class="nav-item" role="presentation">
      <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true">Lista Usuarios</button>
    </li>
    <li class="nav-item" role="presentation">
      <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">Nueva Usuario</button>
    </li>
  </ul>
        ...
        <form method="post" action="{{route('personas.store')}}" id="miFormulario" >
          ...
          <div class="row justify-content-center">
            <div class="col-12 col-sm-12 col-md-6 my-2">
                  <input class="form-control" type="text" id="txtId" name="name" placeholder="Nombre" data-validetta="required">
            </div> 
            <div class="col-12 col-sm-12 col-md-6 my-2">
              <input class="form-control" type="email" id="txtId" name="email" placeholder="Email" data-validetta="required">
            </div> 
            <div class="col-12 col-sm-12 col-md-6 my-2">
              <input class="form-control" type="password" id="txtId" name="password" placeholder="Password" data-validetta="required">
            </div> 
            <div class="col-12 col-sm-12 col-md-6 my-2">
